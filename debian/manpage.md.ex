...
fman - program to do something

# SYNOPSIS

**fman** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**fman** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **fman** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**fman** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    fman. See **foo.conf**(5) for further details.
...
**fman** provides some return codes, that can be used in scripts:
...
Lawal Habeebullahi <habeebullahi01@unknown>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 Lawal Habeebullahi
